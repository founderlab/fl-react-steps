...
var _reactBootstrapLibUtilsTransitionEvents = require('react-bootstrap/lib/utils/TransitionEvents');

var _reactBootstrapLibUtilsTransitionEvents2 = _interopRequireDefault(_reactBootstrapLibUtilsTransitionEvents);
  ...
  _createClass(Step, [{
    ...
    value: function componentDidUpdate() {
      ...
      if (this.state.animate_out) {
        _reactBootstrapLibUtilsTransitionEvents2['default'].addEndEventListener(_reactDom2['default'].findDOMNode(this), this.stopAnimateOut);
      }
    }
  }, {
    key: 'componentWillUnmount',
    value: function componentWillUnmount() {
      _reactBootstrapLibUtilsTransitionEvents2['default'].removeEndEventListener(_reactDom2['default'].findDOMNode(this), this.stopAnimateOut);
    }
  }, {
    key: 'render',
